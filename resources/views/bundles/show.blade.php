                        ...
                        <div class="col-8">
                            ...
                            @if($bundle->validated == True)
                                <div class="row">
                                    ...
                                    <div class="col-4 justify-content-end"><a href="{{ route('bundle.sell', $bundle->id) }}" class="btn btn-sm btn-outline-dark my-1">Retirer de la vente</a></div>
                                </div>
                            @else
                                <div class="row">
                                    <div class="col"><strong class="textcolorinfo">Non vendu</strong></div>
                                    <div class="col-4 justify-content-end"><a href="{{ route('bundle.sell', $bundle->id) }}" class="btn btn-sm btn-outline-dark my-1">Mettre en vente</a></div>
                                </div>
                            @endif
