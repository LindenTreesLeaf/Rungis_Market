                ...
                <div class="contentdisplay my-3">
                    <div class="row">
                        ...
                        <div class="col-4 justify-content-end">
                            ...
                            @if(file_exists(public_path('images/' . $bundle->product . '-120.png')))
                                <img srcset="<?php echo asset('images/' . $bundle->product . '-120.png'); ?> 120w,"
                                    sizes="120px"
                                    src="<?php echo asset('images/' . $bundle->product . '-120.png'); ?>" title={{$bundle->product}} class="img-fluid rounded-lg shadow-lg">
                            @endif
                        </div>
                    </div>
                </div>
