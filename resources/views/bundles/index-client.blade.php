...
<div class="container mx-auto p-6">
    <h1 class="text-2xl font-semibold text-gray-800">Vos produits</h1>

    <a href="{{ route('bundles.create') }}" class="btn bg-purple-600 px-4 py-2 rounded mt-4 inline-block">Créer un Bundle</a>
