...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-center text-purple-600 text-3xl font-bold mb-6">Confirmation de Paiement</h1>
    ...
    <div class="bg-black text-white p-6 rounded-lg shadow-md">
        <h2 class="text-center text-purple-500 text-xl font-semibold mb-4">Commande #{{ $order->id }} Confirmée</h2>
        ...
        <div class="mb-4">
            <strong>Statut de la commande :</strong> <span class="text-green-500 font-semibold">Payée</span>
        </div>
